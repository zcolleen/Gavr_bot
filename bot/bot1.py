...
class Gavr:
    ...
    def __init__(self,username=''):
        ...
        #отключаем все звуки в браузере на время нашей сессии и задаем стандартные размеры окна хрома
    ...
    def login(self):
        ...
        self.driver.get('https://webinar.bmstu.ru/b/vpw-2zy-3k2')# это ссылка на мой баттон
        #http://webinar.bmstu.ru/b/q9y-xew-zr4 - это ссылка на Гаврюшина
        sleep(2)

        code_access = self.driver.find_element_by_xpath('/html/body/div[2]/div/div/div[2]/div[2]/form/div/input[1]')
        ...
        name_access = self.driver.find_element_by_xpath('/html/body/div[2]/div[1]/div/div[2]/div[2]/form/div/input[4]')
